...
class Collection_Page implements Snippet {
	...
	public function process( $data, $jsonld ) {
		 ...
		 */
		if ( true === Helper::get_settings( 'titles.remove_' . $queried_object->taxonomy . '_snippet_data' ) || true === apply_filters( 'rank_math_schema/snippet/remove_taxonomy_data', false, $queried_object->taxonomy ) ) {
			return $data;
		}
