...
class Website implements Snippet {
	...
	public function process( $data, $jsonld ) {
		 ...
		 */
		if ( ! apply_filters( 'rank_math_schema/json_ld/disable_search', false ) ) {
			/**
			 ...
			 */
			$search_url = apply_filters( 'rank_math_schema/json_ld/search_url', home_url( '/?s={search_term_string}' ) );
